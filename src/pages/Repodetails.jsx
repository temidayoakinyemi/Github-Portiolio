...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/temidayoakinyemi/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/temidayoakinyemi/${id}/branches`)
      .then((response) => response.json())
      .then((data) => {
        setBranch(data);
      });
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/temidayoakinyemi/${id}/deployments`)
      .then((response) => response.json())
      .then((data) => {
        setDeployment(data);
      });
      ...
      <div className="repodetail-card">
        ...
        <p>
          ...
          {deployment.length === 0 ? (
            ...
            <a href={`https://temidayoakinyemi.github.io/${details.name}`}>
              temidayoakinyemi.github.io/{details.name}
            </a>
          )}
        </p>
        <p>
